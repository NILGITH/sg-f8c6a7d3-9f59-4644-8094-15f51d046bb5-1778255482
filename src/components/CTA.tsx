...
export function CTA() {
  ...
  return (
    <section id="reservation" className="py-16 md:py-20 lg:py-24 bg-gradient-to-b from-background to-muted/30">
      <div className="container">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={item.title}
              className={`text-center space-y-3 p-6 rounded-xl bg-background border border-border hover:border-primary/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-slide-up stagger-${index + 4}`}
            >
              <div className="w-14 h-14 md:w-16 md:h-16 mx-auto bg-primary/10 rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300">
